...
#include "TMC2209DriverBuffer.h"
#include "../Machine/MachineConfig.h"
#include <atomic>

namespace MotorDrivers {

    void TMC2209DriverBuffer::init() {
        ...
        tmc2209 = new TMC2209StepperBuffer(_uart, _r_sense, _addr, &_uart_buffer_pin);

        registration();
    }

    void TMC2209DriverBuffer::config_motor() {
    ...
    void TMC2209DriverBuffer::set_registers(bool isHoming) {
        if (_has_errors) {
            return;
        }
    ...
    void TMC2209DriverBuffer::debug_message() {
        if (_has_errors) {
            return;
        }
    ...
    void TMC2209DriverBuffer::set_disable(bool disable) {
    ...
    namespace {
        MotorFactory::InstanceBuilder<TMC2209DriverBuffer> registration("tmc_2209_buffered");
    }
}
